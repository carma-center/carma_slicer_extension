...
#
# CMRToolkitRegistrationBRAINSFit
#

class CMRToolkitRegistrationBRAINSFit:
...
#
# CMRToolkitRegistrationBRAINSFitWidget
#

class CMRToolkitRegistrationBRAINSFitWidget:
  ...
  def onRegisterButtonClicked(self):
    print "Performing CMRToolkit registration (BRAINSFit)"
    #method = self.presetComboBox.itemText(self.presetComboBox.currentIndex)
    #print "method = " + method
  ...
  def onReload(self,moduleName="CMRToolkitRegistrationBRAINSFit"):
