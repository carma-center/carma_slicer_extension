...
class Helper( object ):
  ...
  def Info( message ):
    ...
    print "[CMRToolkitPy " + time.strftime( "%m/%d/%Y %H:%M:%S" ) + "]: " + str( message )
    sys.stdout.flush()
  ...
  def Warning( message ):
    ...
    print "[CMRToolkitPy " + time.strftime( "%m/%d/%Y %H:%M:%S" ) + "]: WARNING: " + str( message )
    sys.stdout.flush()
  ...
  def Error( message ):
    ...
    print "[CMRToolkitPy " + time.strftime( "%m/%d/%Y %H:%M:%S" ) + "]: ERROR: " + str( message )
    sys.stdout.flush()
  ...
  def Debug( message ):
    ...
    if showDebugOutput:
        print "[CMRToolkitPy " + time.strftime( "%m/%d/%Y %H:%M:%S" ) + "] DEBUG: " + str( message )
        sys.stdout.flush()
  ...
  def InitVRDisplayNode(vrDisplayNode, volumeID, roiID):
    ...
    print('CMRToolkit VR: will observe ID '+volumeID)
