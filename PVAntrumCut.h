...
namespace itk
{
    ...
    public ImageToImageFilter < TInputImage, TOutputImage >
  {
    public:
      ...
      itkTypeMacro(PVAntrumCut, ImageToImageFilter);
 ...
 protected:
  ...
  private:
    PVAntrumCut(const Self&); //purposely not implemented
 ...
 }; // end class PVAntrumCut

  // DEFINITIONS:

  template <class TInputImage, class TOutputImage>
  PVAntrumCut<TInputImage, TOutputImage>
  ::PVAntrumCut()
  :m_FilterRadius(),
